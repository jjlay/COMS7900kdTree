...
void importFiles(vector<string> files, int myRank,
	...
	cerr << "40000 : importFiles : Rank " << myRank << " starting" << endl;
	...
	*rows = 0;
	...
	for (auto f : files) {
		...
		cerr << "40001 : importFiles : Rank " << myRank << " : Reading file " << filesRead 
			<< " " << ctime(&timenow) << endl;
		filesRead++;
	...
	cerr << "49000 : importFiles : Rank " << myRank << " finished" << endl;
}
