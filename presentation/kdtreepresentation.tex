    ...
    \frametitle{Introduction}
    	...
    	\begin{block}{Objectives:}
    		\begin{itemize}
    			...
    			\item Develop orthogonal recursive bisection ORB algorithm
    			\item Utilize a KD tree to organize data based upon largest dimension at the time of a split
    			\item KD tree data spread across nodes
    			\item Maximize use of MPI using multiple nodes
    			\item Require both Serial and Parallel build and search operations
    			\item Search the KD data with a point and 3 radii
    			\item Print search results 
    		\end{itemize}
    	\end{block}
\end{frame}
% farzi
